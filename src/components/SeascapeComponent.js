                ...
                <div className='row d-flex justify-content-center py-5'>
                    ...
                    <div className='col-12 col-md-8 text-center'>
                        <div className='btn-services-tab'>
                            <Link to='/gallery/landscape' className='btn btn-services font-two'>LANDSCAPE</Link>
                            <span className='btn-services'>|</span>
                            <Link to='/gallery/seascape' className='btn btn-services-active active font-two ml-1'>SEASCAPE</Link>
                            <span className='btn-services'>|</span>
